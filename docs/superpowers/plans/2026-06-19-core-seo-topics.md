...
- [x] **Step 1: Write failing guide data tests**
...
- [x] **Step 3: Extend the guide type**
...
- [x] **Step 4: Author the script-generator guide**
...
- [x] **Step 5: Author the beginner workflow guide**
...
- [x] **Step 1: Write failing rendered-page assertions**
...
- [x] **Step 3: Render related guides safely**
...
- [x] **Step 4: Strengthen the templates owner page**
...
- [x] **Step 6: Run type and unit gates**
...
- [x] **Step 7: Commit rendered topic pages**
...
- [x] **Step 1: Verify responsive topic rendering**
...
- [x] **Step 2: Run every release gate**
...
- [x] **Step 3: Mark local plan steps and commit evidence**
